...
@Component({
  selector: 'app-report15',
  templateUrl: './report15.component.html',
  styleUrls: ['./report15.component.css']
})
export class Report15Component implements OnInit, AfterViewInit {
  ...
  llenarDatosReporte1(idArea: number, nombreArea:string) {
    this.ReportService.report15(idArea).subscribe(
      (response: any) => {
  ...
  public lineChartData: ChartConfiguration['data'] = {
    ...
    labels: this.datosTotalesString2
  };
